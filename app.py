...
from twitter_utils import get_request_token, get_access_token
from twitter_utils import get_oauth_verifier_url
...
def search():
    ...
    tweets = g.user.tweeter_request('https://api.twitter.com/1.1/search/tweets.json?q={}'.format(query), 'GET')
